...
use std::mem::replace;
use std::hash::Hasher;
use mimas_common::{btchn, btpic};
use rand_pcg::Pcg32;
use rand::Rng;
use twox_hash::XxHash64;
use mimas_common::map_storage::PlayerIdPair;
use mimas_common::game_params::{ServerGameParamsHdl};

use mimas_common::map::{Map, MapChunkData, MapBlock, MapBackend, CHUNKSIZE};
use mimas_common::map_storage::DynStorageBackend;
use mimas_common::schematic::Schematic;
...
pub fn server_map_new(seed :u64, params :ServerGameParamsHdl,
		storage :DynStorageBackend) -> ServerMap {
